...
contract Constants {
    ...
    IERC20 constant token1 = IERC20(address(0xE231DB5F348d709239Ef1741EA30961B3B635a61));

    Currency constant currency0 = Currency.wrap(address(token0));
    Currency constant currency1 = Currency.wrap(address(token1));
    IHooks constant hookContract = IHooks(address(0xA8A3c6c5598518E8aaf823F4d26D3F4F54C98888));
...
contract CreatePoolAndAddLiquidityScript is Script, Constants {
    ...
    uint256 public token0Amount = 9e15;
    uint256 public token1Amount = 9e15;
